  ...
  return (
    ...
    >
      <motion.button
        ...
        className="flex items-center justify-center w-12 h-12 rounded-full bg-theme-600 text-white shadow-lg hover:shadow-theme-500/50 transition-all duration-300"
...
function AnimatedThemeOptions({
  ...
  return (
    <motion.div
      ...
      className="absolute left-0 bottom-16 w-36 rounded-lg bg-white dark:bg-gray-800 shadow-lg ring-1 ring-black ring-opacity-5 z-50 border border-gray-200 dark:border-gray-700"
    >
      <div className="py-1">
